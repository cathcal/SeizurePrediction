...
*/
    ...
    var donut = new Morris.Donut({
        ...
        data: [
            {label: "Preictal", value: 10},
            {label: "Interictal", value: 73},
            {label: "Postictal", value: 16}
        ],
        hideHover: 'auto'
    });
    // pie chart
    /*var donutData = [
                    {label: "Preictal", data: 12.17, color: "#3c8dbc"},
                    {label: "others", data: 87.83, color: "#0073b7"}
    ];
    ...
    //bar Chart
    var bar_data = {
        data: [[1, 1], [2, 1], [3, 1], [4, 0], [5, 1], [6, 0], [7, 0], [8, 0], [9, 0], [10, 0], [11, 1], [12, 0],[13, 0], [14, 0], [15, 0], [116, 1], [117, 1], [218, 1], [719, 1], [720, 1], [780, 1], [790, 1]],
        color: "#3c8dbc"
    };
    ...
    var data = [],
        ...
        var plot = $.plot("#EEG-chart", [ getRandomData() ], {
            series: {
