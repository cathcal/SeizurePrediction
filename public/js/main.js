...
function FriendlyChat() {
  this.checkSetup();
  this.email = document.getElementById('reg_email');
  this.password = document.getElementById('reg_password');
  this.submit = document.getElementById('reg_submit');
  this.submit.onclick =  this.signUp.bind(this);
  this.initFirebase();
}
